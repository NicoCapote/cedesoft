...
<body>
    ...
    <div class="card-body mt-2 contenedor col-10" id="contenedor">
        <div class="card">
            ...
            <div class="card-body">
                <ul id="opciones">
                    <li><a href="../php/visitantes/v_empresas.php"><i class="fas fa-building"></i>Empresa</a></li>
                    <li><a href="../php/visitantes/v_sucursal.php"><i class="far fa-building"></i>Sucursal</a></li>
                </ul>
            </div>
        </div>
        <div id="contenido">
            <div class="jumbotron jumbotron-fluid" style="margin-top: 2rem">
                <div class="container">
                    ...
                    <p class="lead">Hola Visitante, solo podras ver las empresas y sus sucursales</p>
                </div>
            </div>
        </div>
    </div>
