...
<body>
    ...
    <div class="card-body mt-2 contenedor col-10" id="contenedor">
        <div class="card">
            ...
            <div class="card-body">
                <ul id="opciones">
                    <li><a href="../php/gestionarusuarios/index.php"><i class="fas fa-file-contract"></i>Usuarios</a></li>
                    ...
                    <li><a href="../php/gestionprocesos/index.php"><i class="fas fa-users"></i>Procesos</a></li>
                </ul>
            </div>
        </div>
        <div id="contenido">
